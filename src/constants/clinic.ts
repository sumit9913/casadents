export const clinicInfo = {
  name: "Casa Dent",
  tagline: "Multispeciality Dental and Facial Esthetic Clinic",
  ...
  // Social Media
  social: {
    facebook: "https://facebook.com/casadent",
    instagram: "https://instagram.com/casadent",
    youtube: "https://youtube.com/casadent"
  },
  
  // Trust Indicators
  trustItems: [
    { icon: "Award", text: "15+ Years Experience" },
    { icon: "Shield", text: "100% Sterilization" },
    { icon: "Heart", text: "Gentle Care Approach" },
    { icon: "Microscope", text: "Advanced Technology" }
  ],
